...
class DistributedMultiSourceSampler(Sampler):
    ...
    Examples:
        ...
        >>>         sampler=dict(type='DistributedMultiSourceSampler',
...
SAMPLERS.register_module(name='MultiSourceSampler', module=DistributedMultiSourceSampler)

@SAMPLERS.register_module()
class DistributedGroupMultiSourceSampler(DistributedMultiSourceSampler):
...
SAMPLERS.register_module(name='GroupMultiSourceSampler', module=DistributedGroupMultiSourceSampler)