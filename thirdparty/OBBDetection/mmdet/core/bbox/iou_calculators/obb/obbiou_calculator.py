...
class OBBOverlaps(object):
    ...
    def __call__(self, bboxes1, bboxes2, mode='iou', is_aligned=False):
        """Calculate IoU between 2D oriented bboxes.
        Args:
            bboxes1 (Tensor): bboxes have shape (m, 5) in <x, y, w, h, angle>
                format, or shape (m, 6) in <x, y, w, h, angle, score> format.
            bboxes2 (Tensor): bboxes have shape (n, 5) in <x, y, w, h, angle>
                format, shape (n, 6) in <x, y, w, h, angle, score> format, or
                be empty. If is_aligned is ``True``, then m and n must be equal.
