...
def prepare_for_cdn_ssod_obb(dn_args, training, num_queries, num_classes, hidden_dim, label_enc, img_metas=None, pseudo_label=False, pseudo_aug_scale=0.06):
...
def dn_post_process_plus_obb(outputs_class, outputs_coord, dn_meta):
    """
