...
CONFIG=configs/unbiased_teacher_v2/ubt2_faster_rcnn_obb_r50_fpn_dota20_partial.py
...
for percent in "${percent_settings[@]}"; do
	...
	for fold in {1..10}; do
		...
		output_folder=partial_ubt2_frcnn_focal/${fold}_${percent}_ubt2_frcnn_${current_date}
