...
CONFIG=configs/mix_teacher/mixT_faster_rcnn_obb_r50_fpn_dota20_full.py
output_folder=full_frcnn_mixT_gsd/full_frcnn_mixT_${current_date}
    ...
    $(dirname "$0")/../../train.py $CONFIG --work-dir $work_dir --launcher=pytorch \
        --cfg-options evaluation.interval=2000000 \
          ...
          checkpoint_config.max_keep_ckpts=100 \
					runner.max_iters=480000 \
					lr_config.step=\[320000,440000\] \
