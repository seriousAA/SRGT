...
CONFIG=configs/srgt/mixT_faster_rcnn_obb_r50_fpn_dota20_partial.py
...
for percent in "${percent_settings[@]}"; do
    ...
    run_name=${fold}_${percent}_mix_srgt_frcnn_${current_date}
		output_folder=partial_mix_srgt_frcnn_gsd/${run_name}
		...
		set +x
			...
			echo "Searching for a GPU with at least 30G of free memory..."
