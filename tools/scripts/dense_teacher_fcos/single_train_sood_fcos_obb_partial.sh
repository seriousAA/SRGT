...
CONFIG=configs/dense_teacher_fcos/sood_fcos_obb_r50_fpn_dota20_partial.py
...
for percent in "${percent_settings[@]}"; do
	...
	for fold in {2..10..2}; do
		...
		output_folder=partial_sood_fcos_obb/${fold}_${percent}_sood_fcos_obb_${current_date}
