...
CONFIG=configs/soft_teacher/softT_faster_rcnn_obb_r50_fpn_dota20_full.py
output_folder=full_frcnn_softT_gsd/full_frcnn_softT_${current_date}
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=${PORT:-29505} \
